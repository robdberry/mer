//! Row/column diacritics for kitty graphics Unicode placeholders.
//!
//! Generated from kitty's `gen/rowcolumn-diacritics.txt`. The diacritic at index `n`
//! encodes row or column number `n`.
